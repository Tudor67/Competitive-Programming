...
public:
    ...
    static void heapDown(vector<int>& h, int heapSize, Comp& comp, int i){
    ...
    template<typename Comp>
    static void makeHeap(vector<int>& h, int heapSize, Comp& comp){
    ...
    template<typename Comp>
    static void popHeap(vector<int>& h, int& heapSize, Comp& comp){
